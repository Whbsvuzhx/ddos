...
FORWARD_CHANNEL_ID = --1002414462452
CHANNEL_ID = --1002414462452
error_channel_id = --1002414462452
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @KIING_OP* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @KIING_OP* 🙏"  # Contact owner message
    else:
